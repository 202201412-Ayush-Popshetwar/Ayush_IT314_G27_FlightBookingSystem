...
const CarouselList = () => {
    return (
        <Carousel>
            <Carousel.Item>
                <img style={{height:'80vh'}} src="../../../public/img/Carousel/first.png" alt="" className="d-block w-100" />
            ...
            <Carousel.Item>
                <img style={{height:'60vh'}} src="../../../public/img/Carousel/second.png" alt="" className="d-block w-100" />
                <Carousel.Caption>
            ...
            <Carousel.Item>
                <img style={{height:'80vh'}} src="../../../public/img/Carousel/third.jpg" alt="" className="d-block w-100" />
                <Carousel.Caption>
            ...
            <Carousel.Item>
                <img style={{height:'80vh'}} src="../../../public/img/Carousel/fourth.png" alt="" className="d-block w-100" />
                <Carousel.Caption>
