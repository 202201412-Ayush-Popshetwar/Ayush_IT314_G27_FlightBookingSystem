            ...
            <table className="min-w-full border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50">
                  <th className="p-3 text-left text-sm font-semibold text-gray-600">Booking ID</th>
                  <th className="p-3 text-left text-sm font-semibold text-gray-600">Route</th>
                  <th className="p-3 text-left text-sm font-semibold text-gray-600 hidden md:table-cell">Date</th>
                  <th className="p-3 text-left text-sm font-semibold text-gray-600">Class</th>
                  <th className="p-3 text-left text-sm font-semibold text-gray-600 hidden md:table-cell">Passengers</th>
